...
class BatchTransaction extends Snapshot {
   ...
   *
   * @example <caption>include:samples/batch-create-and-execute-query-partitions.js</caption>
   ...
   *
   * @example <caption>include:samples/batch-execute-partition.js</caption>
