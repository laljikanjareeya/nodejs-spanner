...
// sample-metadata:
//  title: Execute a read-only SQL query with a commit timestamp column.
//  usage: node queryTableWithTimestamp <INSTANCE_ID> <DATABASE_ID> <PROJECT_ID>
...
function main(
  ...
  async function queryTableWithTimestamp() {
  ...
  queryTableWithTimestamp().catch(console.error);
