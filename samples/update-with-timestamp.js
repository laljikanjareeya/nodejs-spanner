...
// sample-metadata:
//  title: Modify existing rows of data with a commit timestamp column.
//  usage: node updateWithTimestamp <INSTANCE_ID> <DATABASE_ID> <PROJECT_ID>
...
function main(
  ...
  updateWithTimestamp().catch(console.error);
