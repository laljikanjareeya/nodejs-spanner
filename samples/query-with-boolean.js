...
// sample-metadata:
//  title: Query With Boolen parameter
//  usage: node queryWithBooleanParameter <INSTANCE_ID> <DATABASE_ID> <PROJECT_ID>
...
function main(
  ...
  async function queryWithBooleanParameter() {
  ...
  queryWithBooleanParameter().catch(console.error);
